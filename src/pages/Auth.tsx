...
export default function Auth() {
  ...
  const getTitle = () => {
    switch (mode) {
      ...
      case 'signup': return 'Crie sua conta grátis';
      case 'forgot': return 'Recuperar senha';
      case 'reset': return 'Definir nova senha';
    }
  };
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-primary items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-primary-foreground/80 text-lg">
            Resumos, explicações simples, sugestões de melhoria e versões aprimoradas em segundos.
          </p>
        </motion.div>
      </div>
    </div>
